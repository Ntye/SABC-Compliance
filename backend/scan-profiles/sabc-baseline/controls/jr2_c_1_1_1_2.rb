control 'JR2.C.1.1.1.2' do
  title 'Ensure mounting of freevxfs filesystems is disabled.'
  impact 0.5
  tag cis_level: 1
  tag control_key: 'jr2_c_1_1_1_2'
  if os.debian?
...
/bin/bash <<'SABC_BASH_EOF'
#!/usr/bin/env bash
# Compliant when the freevxfs kernel module cannot be loaded and is not loaded.
lsmod | grep -q '^freevxfs\b' && exit 1
