...
class sabc_hardening::jr2_c_3_4_1_1 {
  ...
  if $facts['os']['family'] == 'RedHat' {
    $cfg_redhat = find_file('sabc_hardening/jr2_c_3_4_1_1_redhat_cfg.sh')
    $chk_redhat = find_file('sabc_hardening/jr2_c_3_4_1_1_redhat_chk.sh')
    exec { 'sabc_jr2_c_3_4_1_1_redhat':
