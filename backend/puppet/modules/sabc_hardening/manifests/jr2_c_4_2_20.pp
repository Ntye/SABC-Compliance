...
class sabc_hardening::jr2_c_4_2_20 {
  if $facts['os']['family'] == 'Debian' {
    $cfg_debian = find_file('sabc_hardening/jr2_c_4_2_20_debian_cfg.sh')
    $chk_debian = find_file('sabc_hardening/jr2_c_4_2_20_debian_chk.sh')
  ...
  if $facts['os']['family'] == 'RedHat' {
    $cfg_redhat = find_file('sabc_hardening/jr2_c_4_2_20_redhat_cfg.sh')
    $chk_redhat = find_file('sabc_hardening/jr2_c_4_2_20_redhat_chk.sh')
