...
class sabc_hardening::jr2_c_1_7_3 {
  if $facts['os']['family'] == 'Debian' {
    $cfg_debian = find_file('sabc_hardening/jr2_c_1_7_3_debian_cfg.sh')
    $chk_debian = find_file('sabc_hardening/jr2_c_1_7_3_debian_chk.sh')
    exec { 'sabc_jr2_c_1_7_3_debian':
