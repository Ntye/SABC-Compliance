...
class IComplianceRepository(ABC):
    ...
    @abstractmethod
    async def find_history(self, node_id: str | None = None, since: str | None = None,
                           until: str | None = None, limit: int = 1000) -> list[dict]: ...
    @abstractmethod
...
class INotificationRepository(ABC):
    """Store for in-platform notifications (header bell)."""
    @abstractmethod
...
class IComplianceGroupRepository(ABC):
    @abstractmethod
